    ...
    <section className=" relative overflow-hidden pb-150  max-md:pb-25 ">
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-center gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <CoreValueAnimation />
          <div>
            <p className="section-tagline">Our Guiding Principles</p>
            <h2 className=" mb-8 max-md:mb-4">The Core Philosophy That Drives Our Organization.</h2>
            <p className="mb-11  max-md:mb-6">
              Our core philosophy focuses on delivering innovative digital solutions that drive measurable success and
              growth for clients.
            </p>
            <ul className="mb-14 [&>*:not(:last-child)]:mb-6 max-md:[&>*:not(:last-child)]:mb-4">
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="dark:text-white"> Strategic Innovation </span>
              </li>
              <li className="flex items-center gap-x-2">
                ...
                <span className="dark:text-white"> Technical Mastery </span>
              </li>
              <li className="flex items-center gap-x-2 ">
                <span className=" shadow-icon  item-center relative flex justify-center rounded-full bg-white dark:bg-dark-200">
                  <svg xmlns="http://www.w3.org/2000/svg" width="28" height="30" viewBox="0 0 28 30" fill="none">
