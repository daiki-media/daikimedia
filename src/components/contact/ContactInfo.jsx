      ...
      <div className="container ">
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-2 gap-8 max-md:grid-cols-1">
            <FadeUpAnimation className="rounded-medium bg-white p-2.5 shadow-box dark:bg-dark-200 group">
              <div className="h-full rounded border border-dashed border-gray-100 p-10 text-center dark:border-borderColor-dark max-lg:p-5">
                <svg
                  ...
                  viewBox="0 0 40 40"
                  fill="none"
                  className="mb-6 inline-block group-hover:scale-110 group-hover:rotate-3 transition-all duration-300"
                >
                  <path
                ...
                <Link
                  ...
                  className="relative inline-block text-paragraph dark:text-white hover:text-primary-600 dark:hover:text-primary-400 transition-all duration-300 group-hover:scale-105 font-medium"
                >
                  <span className="relative z-10">lukesh@daikimedia.com</span>
                  <span className="absolute inset-0 bg-gradient-to-r from-primary-400/20 to-primary-600/20 rounded-lg scale-0 group-hover:scale-100 transition-transform duration-300 origin-center -z-10"></span>
            ...
            <FadeUpAnimation className="rounded-medium bg-white p-2.5 shadow-box dark:bg-dark-200 group">
              ...
              38.3086 9.89256C38.3086 21.8246 21.8789 38.2653 9.94143 38.2653L9.93362 38.32Z"
                ...
                <h3 className="mb-2.5 group-hover:text-primary-600 transition-all duration-300">Call Us</h3>
                <Link
                  href="tel:+391(0)355684593"
                  className="relative inline-block text-paragraph dark:text-white hover:text-primary-600 dark:hover:text-primary-400 transition-all duration-300 group-hover:scale-105 font-medium"
                >
                  <span className="relative z-10">601114850067</span>
                </Link>
              </div>
            </FadeUpAnimation>
          </div>
